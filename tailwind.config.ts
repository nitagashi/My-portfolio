  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        aurora3: {
          "0%, 100%": { transform: "translateX(0%) translateY(0%) rotate(0deg)" },
          "25%": { transform: "translateX(6%) translateY(-2%) rotate(2deg)" },
          "75%": { transform: "translateX(-4%) translateY(3%) rotate(-2deg)" },
        },
      },
      animation: {
        ...
        aurora2: "aurora2 12s ease-in-out infinite",
        aurora3: "aurora3 10s ease-in-out infinite",
      },
    },
  },
